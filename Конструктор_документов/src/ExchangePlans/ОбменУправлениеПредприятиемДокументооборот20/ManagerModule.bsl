...
Процедура ОпределитьНастройки(Настройки, ИдентификаторНастройки) Экспорт
	...
	Настройки.ВариантыНастроекОбмена = Новый Массив;
	Настройки.ВариантыНастроекОбмена.Добавить("УП");
	Настройки.ВариантыНастроекОбмена.Добавить("КА");
	
	Если ИдентификаторНастройки = "КА" Тогда
		Синоним = НСтр("ru = '1С:Комплексная автоматизация, ред. 2.1'");
	ИначеЕсли ИдентификаторНастройки = "УП" Тогда
		Синоним = НСтр("ru = '1С:ERP Управление предприятием, ред. 2'");
	Иначе
		Синоним = НСтр("ru = '1С:ERP Управление предприятием 2 / 1С:Комплексная автоматизация 2'");
	КонецЕсли;
	Настройки.ЗаголовокКомандыДляСозданияНовогоОбменаДанными = Синоним;
	Настройки.ЗаголовокПомощникаСозданияОбмена = СтрШаблон(НСтр("ru = 'Синхронизация данных с конфигурацией %1 (настройка)'"), Синоним);
	Настройки.НаименованиеКонфигурацииКорреспондента = Синоним;
	Настройки.ЗаголовокУзлаПланаОбмена = Синоним;
...
Функция ИмяФайлаНастроекДляПриемника() Экспорт
	...
	Возврат НСтр("ru = 'Настройки обмена УП-ДО'");
...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru = '1С:Управление предприятием, ред. 2'");
...
Функция ПодробнаяИнформацияПоОбмену(ИдентификаторНастройки) Экспорт
	...
	ИначеЕсли ИдентификаторНастройки = "КА" Тогда
		...
		Возврат "ПланОбмена.ОбменУправлениеПредприятиемДокументооборот20.Форма.ПодробнаяИнформацияКА";
		
	Иначе
		
		Возврат "ПланОбмена.ОбменУправлениеПредприятиемДокументооборот20.Форма.ПодробнаяИнформация";
