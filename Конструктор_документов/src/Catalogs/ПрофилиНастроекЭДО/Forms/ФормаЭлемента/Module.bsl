...
&НаКлиенте
Процедура ВключитьЗакладкуВидыЭлектронныхДокументов(Команда)
	
	Элементы.ГруппаИсходящиеДокументы.Видимость = Истина;
	Элементы.ФормаВключитьДополнительныеНастройки.Видимость = Ложь;
