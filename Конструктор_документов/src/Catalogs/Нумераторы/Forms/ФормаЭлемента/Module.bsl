...
Процедура ЗаполнитьНезависимуюНумерацию()
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьУчетПоОрганизациям") Тогда
		НезависимаяНумерация.Добавить("НезависимаяНумерацияПоОрганизациям", НСтр("ru = 'Организации'"));
	КонецЕсли;
...
Процедура ЗаполнитьСлужебныеПоля()
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьУчетПоОрганизациям") Тогда 
		СлужебныеПоля.Добавить(НСтр("ru = '[ИндексОрг]'"), НСтр("ru = 'Индекс организации'"));
	КонецЕсли;	
