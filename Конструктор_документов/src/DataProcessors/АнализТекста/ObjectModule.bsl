...
// Вычисляет длину аннотации.
//
// Параметры:
//  Аннотация - Структура - Аннотация.
// 
// Возвращаемое значение:
//  Число - Длина аннотации.
//
Функция АннотацияДлина(Аннотация)
	
	Возврат СтрДлина(Аннотация.Данные);
...
// Ищет токены определенного типа в аннотации.
//
// Параметры:
//  Аннотация	 - Структура - Аннотация.
//  Тип			 - Строка	 - Тип токена.
// 
// Возвращаемое значение:
//  Массив - Найденные токены.
//
Функция АннотацияНайтиТокены(Аннотация, Тип)
	
	Токены = Новый Массив;
	Для Каждого Токен Из АннотацияПолучитьТокены(Аннотация) Цикл
...
// Формирует массив слов времени года.
//
// Возвращаемое значение:
//  Массив - массив слов времени года.
//
Функция ВременаГода()
	
	ВременаГода = Новый Массив;
	ВременаГода.Добавить("летом");
	ВременаГода.Добавить("осенью");
	ВременаГода.Добавить("весной");
	ВременаГода.Добавить("зимой");
...
// Формирует массив слов неделя.
//
// Возвращаемое значение:
//  Массив - массив слов неделя.
//
Функция Неделя()
	
	Неделя = Новый Массив;
	Неделя.Добавить("неделе");
	Неделя.Добавить("неделей");
	Неделя.Добавить("неделею");
	Неделя.Добавить("недели");
	Неделя.Добавить("недель");
	Неделя.Добавить("неделю");
	Неделя.Добавить("неделя");
	Неделя.Добавить("неделям");
	Неделя.Добавить("неделями");
	Неделя.Добавить("неделях");
...
// Формирует массив предлогов места.
//
// Возвращаемое значение:
//  Массив - массив предлогов места.
//
Функция ПредлогиМеста()
	
	ПредлогиМеста = Новый Массив;
	ПредлогиМеста.Добавить("на");
	ПредлогиМеста.Добавить("в");
	ПредлогиМеста.Добавить("около");
	ПредлогиМеста.Добавить("возле");
	ПредлогиМеста.Добавить("у");
	
	Возврат ПредлогиМеста;
...
// Формирует шаблон два числа. Например, "8-101".
//
// Возвращаемое значение:
//  Массив - Шаблон два числа.
//
Функция ДваЧисла(Текст)
