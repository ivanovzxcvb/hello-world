...
&НаКлиенте
Процедура ОбновитьИнформациюОНаличииСоединений()
	
	ИмяПараметра = "СтандартныеПодсистемы.СообщенияДляЖурналаРегистрации";
	Если Элементы.СтраницыПомощника.ТекущаяСтраница = Элементы.ВыборРежимаОбновленияФайл Тогда
	...
	ИначеЕсли Элементы.СтраницыПомощника.ТекущаяСтраница = Элементы.ВыборРежимаОбновленияСервер Тогда
...
Функция ВозможенЗапускОбновления()
	...
	Если Не ВозможенЗапускОбновления Тогда
		...
		ЖурналРегистрацииКлиент.ДобавитьСообщениеДляЖурналаРегистрации(ИмяСобытияЖурнала,, ТекстСообщения,, Истина);
	КонецЕсли;
