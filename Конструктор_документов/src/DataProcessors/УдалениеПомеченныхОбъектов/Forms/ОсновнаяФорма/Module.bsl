...
Процедура ВыполнитьУдаление()
	...
	ИнициироватьУдалениеВыбранныхНаСервере(ИдентификаторФЗ, АдресХранилищаРезультата, 
		КоличествоУдаляемых, СообщениеОбОшибке);
...
Процедура ОбработатьРезультатУдаления(ФормаДлительнойОперации)
	...
	Если ОбработатьРезультатУдаленияНаСервере(АдресХранилищаРезультата, ТипыУдаленныхОбъектов,
			КоличествоУдаляемых, СообщениеОбОшибке) Тогда
