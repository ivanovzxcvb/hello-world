...
// Возвращает возможности пути схемы комплексного процесса по таблице предшественников,
// исключая циклы.
//
// Параметры:
...
//
// Параметры:
//  Пути - Массив - см. ПутиСхемыКомплексногоПроцесса.
...
Функция ДатаОтсчетаДействияКомплексногоПроцессаВФорме(Форма) Экспорт
	...
	Если Форма.ИспользоватьСхемуПроцесса Тогда
		...
		ПутиСхемы = СрокиИсполненияПроцессовКлиентСерверКОРП.ПутиСхемыКомплексногоПроцесса(
