...
// см. описание в ПрисоединенныеФайлыПереопределяемый.ПриОпределенииСправочниковХраненияФайлов
//
...
// см. описание в ПрисоединенныеФайлыПереопределяемый.ПриОпределенииОбъектовИсключенияОчисткиФайлов
//
...
// см. описание в ЭлектроннаяПодписьПереопределяемый.ПриСозданииФормыПроверкаСертификата
//
