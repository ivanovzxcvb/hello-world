	...
	Для Каждого ОписаниеСвойства Из ОписаниеСвойств Цикл
		...
		Для Каждого СтрокаТаблицы Из ОписаниеСвойства.ЗависимостиДополнительныхРеквизитов Цикл
			...
			Если ЗначениеЗаполнено(ШаблонУсловия) Тогда
				Индекс = ОписаниеСвойства.ЗависимостиДополнительныхРеквизитов.Индекс(СтрокаТаблицы);
				КлючПараметра = ПутьКРеквизиту + Индекс; // для одного реквизита может быть задано несколько условий
				ПравоеЗначение = "ЗначенияПараметров[""" + КлючПараметра + """]";
			Иначе
				КлючПараметра = ПутьКРеквизиту;
			КонецЕсли;
			...
			Если СтрокаТаблицы.ЗависимоеСвойство = "Доступен" Тогда
				УстановитьУсловиеЗависимости(ОписаниеЗависимогоРеквизита.УсловиеДоступности, КлючПараметра, СтрокаТаблицы, КодУсловия);
			ИначеЕсли СтрокаТаблицы.ЗависимоеСвойство = "Виден" Тогда
				УстановитьУсловиеЗависимости(ОписаниеЗависимогоРеквизита.УсловиеВидимости, КлючПараметра, СтрокаТаблицы, КодУсловия);
			Иначе
				УстановитьУсловиеЗависимости(ОписаниеЗависимогоРеквизита.УсловиеОбязательностиЗаполнения, КлючПараметра, СтрокаТаблицы, КодУсловия);
			КонецЕсли;
		КонецЦикла;
...
Процедура УстановитьУсловиеЗависимости(СтруктураЗависимостей, КлючПараметра, СтрокаТаблицы, КодУсловия)
	Если СтруктураЗависимостей = Неопределено Тогда
		ЗначенияПараметров = Новый Соответствие;
		ЗначенияПараметров.Вставить(КлючПараметра, СтрокаТаблицы.Значение);
	...
	Иначе
		...
		СтруктураЗависимостей.ЗначенияПараметров.Вставить(КлючПараметра, СтрокаТаблицы.Значение);
	КонецЕсли;
КонецПроцедуры
