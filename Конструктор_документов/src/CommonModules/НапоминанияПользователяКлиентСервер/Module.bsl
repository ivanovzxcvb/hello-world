...
Функция ПолучитьСтандартныеИнтервалыОповещения() Экспорт
	...
	ИнтервалыВремени.Вставить(НСтр("ru = '_5м'"));
	ИнтервалыВремени.Вставить(НСтр("ru = '_10м'"));
	ИнтервалыВремени.Вставить(НСтр("ru = '_15м'"));
	ИнтервалыВремени.Вставить(НСтр("ru = '_30м'"));
	ИнтервалыВремени.Вставить(НСтр("ru = '_1ч'"));
	ИнтервалыВремени.Вставить(НСтр("ru = '_2ч'"));
	ИнтервалыВремени.Вставить(НСтр("ru = '_4ч'"));
	ИнтервалыВремени.Вставить(НСтр("ru = '_8ч'"));
	ИнтервалыВремени.Вставить(НСтр("ru = '_1д'"));
	ИнтервалыВремени.Вставить(НСтр("ru = '_2д'"));
	ИнтервалыВремени.Вставить(НСтр("ru = '_3д'"));
	ИнтервалыВремени.Вставить(НСтр("ru = '_1н'"));
	ИнтервалыВремени.Вставить(НСтр("ru = '_2н'"));
