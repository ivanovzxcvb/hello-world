...
Функция ПолучитьОсновнойНаборСвойствДляОбъекта(ВладелецСвойств)
	...
	ИначеЕсли ИмяОбъектаМетаданных = "ШаблоныИсполнения" Тогда 
		ИмяОбъектаМетаданных = "Исполнение";
	ИначеЕсли ИмяОбъектаМетаданных = "ШаблоныКомплексныхБизнесПроцессов" Тогда 
		ИмяОбъектаМетаданных = "КомплексныйПроцесс";
	ИначеЕсли ИмяОбъектаМетаданных = "ШаблоныОзнакомления" Тогда 
		ИмяОбъектаМетаданных = "Ознакомление";
	ИначеЕсли ИмяОбъектаМетаданных = "ШаблоныПоручения" Тогда 
		ИмяОбъектаМетаданных = "Поручение";
	ИначеЕсли ИмяОбъектаМетаданных = "ШаблоныПриглашения" Тогда 
		ИмяОбъектаМетаданных = "Приглашение";
	ИначеЕсли ИмяОбъектаМетаданных = "ШаблоныРассмотрения" Тогда 
		ИмяОбъектаМетаданных = "Рассмотрение";
	ИначеЕсли ИмяОбъектаМетаданных = "ШаблоныРегистрации" Тогда 
		ИмяОбъектаМетаданных = "Регистрация";
	ИначеЕсли ИмяОбъектаМетаданных = "ШаблоныСогласования" Тогда 
		ИмяОбъектаМетаданных = "Согласование";
	ИначеЕсли ИмяОбъектаМетаданных = "ШаблоныСоставныхБизнесПроцессов" Тогда 
		ИмяОбъектаМетаданных = "ОбработкаВнутреннегоДокумента";
	ИначеЕсли ИмяОбъектаМетаданных = "ШаблоныУтверждения" Тогда 
		ИмяОбъектаМетаданных = "Утверждение";
	КонецЕсли;
	...
	Если ИмяЭлемента = "Справочник_ВидыВнутреннихДокументов" 
		Или ИмяЭлемента = "Справочник_ВидыВходящихДокументов" 
		Или ИмяЭлемента = "Справочник_ВидыИсходящихДокументов" Тогда 
		Возврат Ссылка.НаборСвойств;
	Иначе 
