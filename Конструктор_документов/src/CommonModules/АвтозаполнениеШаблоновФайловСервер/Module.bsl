...
Процедура ОбновитьВерсиюИзДвоичныхДанных(ДвоичныеДанные, Объект, КомментарийКНовойВерсии = "", УникальныйИдентификатор = Неопределено, НеСоздаватьНовуюВерсию = Ложь) Экспорт
	...
	Если НЕ НеСоздаватьНовуюВерсию Тогда 
