...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ДанныеЗаполнения <> Неопределено Тогда
		...
		НоваяСтрока.ДокументОснование = ОснованиеСсылка;
		...
		ПараметрыСоглашения = ОбменСКонтрагентамиСлужебный.ОпределитьНастройкиОбменаЭДПоИсточнику(ЭтотОбъект,,,,ВидЭД);
		Если ЗначениеЗаполнено(ПараметрыСоглашения) Тогда

			ПрофильНастроекЭДО = ПараметрыСоглашения.ПрофильНастроекЭДО;
			НастройкаЭДО = ПараметрыСоглашения.СоглашениеЭД;
		КонецЕсли;
		
		Ответственный = ОбменСКонтрагентамиПереопределяемый.ПолучитьОтветственногоПоЭД(Контрагент,НастройкаЭДО);
